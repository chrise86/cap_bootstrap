...
Setup a new Ubuntu 12.10 slice. Add a user called deployer with sudo privileges.
...
### Ruby
    ...
    set :ruby_version, "1.9.3-p362"
    set :rbenv_bootstrap, "bootstrap-ubuntu-12-04" # Or bootstrap-ubuntu-11-10 or bootstrap-ubuntu-10-04
